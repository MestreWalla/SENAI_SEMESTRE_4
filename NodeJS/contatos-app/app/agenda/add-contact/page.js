  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('/api/contacts', {
        ...
        body: JSON.stringify({ name, phone, email, profilePicture }),
      });
  ...
  return (
    <div style={{ padding: '20px' }}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button
          type="submit"
          style={{ padding: '10px 20px', backgroundColor: '#b9aac2', color: 'white', border: 'none', borderRadius: '4px', cursor: 'pointer' }}
        >
          Cadastrar
        </button>
      </form>
